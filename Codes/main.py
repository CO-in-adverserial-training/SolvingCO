...
def parse_args():
    ...
    parser.add_argument("--attack", choices=["SIA", "FGSM", "FGSM-RS", "GradAlign", "NFGSM", "ZeroGrad", "ATAS", "ELLE", "TRADES", "PGD"], required=True)
    ...
    parser.add_argument("--plot_accs_vs_eps", action="store_true")
