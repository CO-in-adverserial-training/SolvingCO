...
def parse_args():
    ...
    parser.add_argument("--model", choices=["PreActResNet18", "ResNet18", "WideResNet28", "SENet18", "VitSmall", "VitBase", "ViT", "ViTCIFAR10"], default="PreActResNet18")
    parser.add_argument("--attack", choices=["SORA", "SORAN", "FGSM", "FGM", "FGSM-RS", "FGM-RS", "GradAlign", "NuAT", "FastBat", "NFGSM", "AAER", "ZeroGrad", "MultiGrad", "ATAS", "ELLE", "TRADES", "PGD", "PGD2", "Benign"], required=True)
