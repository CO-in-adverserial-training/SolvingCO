...
def parse_args():
    ...
    parser.add_argument("--attack", choices=["SORA", "SORAN", "FGSM", "FGM", "FGSM-RS", "GradAlign", "NuAT", "FastBat", "NFGSM", "AAER", "ZeroGrad", "MultiGrad", "ATAS", "ELLE", "TRADES", "PGD", "PGD2", "Benign"], required=True)
