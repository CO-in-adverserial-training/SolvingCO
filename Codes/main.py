...
def parse_args():
    ...
    parser.add_argument("--attack", choices=["SORA", "SORAN", "FGSM", "FGSM-RS", "GradAlign", "NuAT", "NFGSM", "AAER", "ZeroGrad", "MultiGrad", "ATAS", "ELLE", "TRADES", "PGD", "PGD2", "Benign"], required=True)
