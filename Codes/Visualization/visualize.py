...
def visualize(args):
    ...
    training_metrics_path = f"{args.root_path}/Results/{args.dataset}/{args.model}/{args.attack}/raw_results/train_metrics_{args.epochs}_{args.seed}.json"
    evaluation_metrics_path = f"{args.root_path}/Results/{args.dataset}/{args.model}/{args.attack}/raw_results/evaluation_metrics_{args.epochs}_{args.seed}.json"
